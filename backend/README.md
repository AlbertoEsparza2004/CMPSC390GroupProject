...
Run these queries to confirm data is present:
...
Expected: Confirmation message that API is running
...
This route must be tested using Thunder Client or Postman.
...
Paste the login JSON

Click Send

Important Notes

Visiting /login in a browser will show:
Cannot GET /login
